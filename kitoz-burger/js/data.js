...
window.MENU = [
  ...
  },
  {
    ...
    items: [
      { name: "Fountain Drink", price: 3, desc: "Refillable fountain soda." },
      { name: "Agua Fresca", price: 4, desc: "House-made. Choose your flavor in notes." },
      { name: "Shirley Temple", price: 4, desc: "Choose your flavor in notes." }
    ]
  }
];
